                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info">
                            <ul>
                                <li><i class="fi-rs-smartphone"></i> (+01) - 2345 - 6789</li>
                                <li><i class="fi-rs-marker"></i>Our location</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Selamat datang di kafe "D COFFEE LOE" </li>
                                    <li>Dapatkan Promo 15% di hari Rabu & Jumat</li>
                                    <li>Nikmati kopi kafe favoritmu di rumah! Pesan online sekarang</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                <li>
                                    <a class="language-dropdown-active" > <i class="fi-rs-world"></i>
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li><a href="shop-grid-right.html"></i>Coffee</a></li>
                                    <li><a href="shop-grid-right.html"></i>Non-Coffee</a></li>
                                    <li><a href="shop-grid-right.html"></i>Snack</a></li>
                                    <li><a href="shop-grid-right.html"></i>Dessert</a></li>
                                    <li><a href="shop-grid-right.html"></i>Food</a>
                                    </li>
                                </ul>
                                    ...
                                    <li class="position-static"><a href="#">Mega menu <i
                                        ...
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Coffee & Non-Coffee</a>
                                                <ul>
                                                    <li><a href="shop-product-right.html">Ekspresoo</a></li>
                                                    <li><a href="shop-product-right.html">Americano</a></li>
                                                    <li><a href="shop-product-right.html">Mocha Latte</a>
                                                    </li>
                                                    <li><a href="shop-product-right.html">Matcha Lattee</a></li>
                                                    <li><a href="shop-product-right.html">Kiwi Starfruit</a></li>
                                                    <li><a href="shop-product-right.html">Strawberry Soda</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Snack & Desert</a>
                                                <ul>
                                                    <li><a href="shop-product-right.html">Dimsum Mentai</a></li>
                                                    <li><a href="shop-product-right.html">Gyoza Chili Oil</a></li>
                                                    <li><a href="shop-product-right.html">Chesee Stick</a></li>
                                                    <li><a href="shop-product-right.html">Stawberry Sando</a></li>
                                                    <li><a href="shop-product-right.html">Ichigo Daifuku Mochi</a></li>
                                                    <li><a href="shop-product-right.html">Mille Crepes Matcha</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Food</a>
                                                <ul>
                                                    <li><a href="shop-product-right.html">Chicken Steak</a></li>
                                                    <li><a href="shop-product-right.html">Bibimbap</a></li>
                                                    <li><a href="shop-product-right.html">Spaghetti Carbonara</a></li>
                                                    <li><a href="shop-product-right.html">Chicken Katsu</a></li>
                                                    <li><a href="shop-product-right.html">Jajangmyeon Korea</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img
                                                            src="{{ asset('evara') }}/assets/imgs/banner/banner.png"
                                                            alt="Evara"></a>
                                                    <div class="menu-banner-content">
                                                        <h4>Hot deals</h4>
                                                        <h3>Don't miss<br> Discount</h3>
                                ...
                                <div class="row align-items-center slider-animated-1">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="hero-slider-content-2">
                                            <h4 class="animated">Nikmati!</h4>
                                            <h3 class="animated fw-900">Promo Spesial</h3>
                                            <h2 class="animated fw-900 text-brand">D COFFEE LOE</h2>
                                            <p class="animated">Diskon 20% untuk pelanggan setia kami sebelum pukul 9 pagi!</p>
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="single-slider-img single-slider-img-1">
                                            <img class="animated"
                                                src="{{ asset('evara') }}/assets/imgs/slider/k1.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="single-hero-slider single-animation-wrap">
                            <div class="container">
                                <div class="row align-items-center slider-animated-1">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="hero-slider-content-2">
                                            <h4 class="animated">Rasakan Kelezatan</h4>
                                            <h3 class="animated fw-900">Semua Menu Kami!</h3>
                                            <h2 class="animated fw-900 text-brand">Coffee is our Passion</h2>
                                            <p class="animated">Diskon 20% untuk pelanggan setia kami sebelum pukul 9 pagi!</p>
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="single-slider-img single-slider-img-1">
                                            <img class="animated"
                                                src="{{ asset('evara') }}/assets/imgs/slider/k2.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                <li><a href="shop-grid-right.html">12k-18k</a></li>
                                <li><a href="shop-grid-right.html">18k-23k</a></li>
                                <li><a href="shop-grid-right.html">23k-25k</a></li>
                            </ul>
                        </div>
                                        ...
                                        <div class="product-cart-wrap mb-30">
                                            <div class="product-img-action-wrap">
                                                ...
                                                <div class="product-action-1">
                                                    <a aria-label="Quick view" class="action-btn hover-up open-AddBookDialog"
