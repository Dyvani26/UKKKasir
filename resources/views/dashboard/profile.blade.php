                            ...
                            <div class="card-body box-profile">
                                ...
                                <div class="modal fade" id="uploadPhoto" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <form action="{{ route('petugas.photo', $data->id) }}"
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="active tab-pane" id="activity">
                                        <form action="{{ route('petugas.profile', $data->id) }}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <label for="">NIK</label>
                                            ...
                                            <input type="date" class="form-control" name="tgl_lahir"
                                                value="{{ $data->detailUser->tgl_lahir }}">
                                            ...
                                            <input type="text" class="form-control" name="no_tlfn"
                                                value="{{ $data->detailUser->no_tlfn }}">
